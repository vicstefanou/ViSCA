...
#' \itemize{
#' \item \code{"name"} is the label of the cell, a non-zero positive integer number stored as a character string.
...
#' (i.e. the colony of the corresponding colony's \emph{root} cell from which a cell instant emerged).
